...
生成时间：2026-08-16T06:59:19.761Z（由 `pnpm verify` 自动生成，勿手改）

| 门禁步骤 | 命令 | 结果 | 耗时 |
|---|---|---|---|
| typecheck（tsc --noEmit 双 tsconfig） | `corepack pnpm typecheck` | ✅ PASS | 28.1s |
...
| 隐私 grep（privacy:check） | `corepack pnpm privacy:check` | ✅ PASS | 0.4s |
...
```
 [32m✓[39m tests/unit/trace-sink.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 11[2mms[22m[39m

[2m Test Files [22m [1m[32m9 passed[39m[22m[90m (9)[39m
[2m      Tests [22m [1m[32m66 passed[39m[22m[90m (66)[39m
[2m   Start at [22m 06:59:17
[2m   Duration [22m 2.30s[2m (transform 443ms, setup 0ms, import 809ms, tests 105ms, environment 1ms)[22m
```
