...
生成时间：2026-08-16T05:11:35.621Z（由 `pnpm verify` 自动生成，勿手改）

| 门禁步骤 | 命令 | 结果 | 耗时 |
|---|---|---|---|
| typecheck（tsc --noEmit 双 tsconfig） | `corepack pnpm typecheck` | ✅ PASS | 29.6s |
...
```
 [32m✓[39m tests/unit/trace-sink.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 12[2mms[22m[39m

[2m Test Files [22m [1m[32m9 passed[39m[22m[90m (9)[39m
[2m      Tests [22m [1m[32m66 passed[39m[22m[90m (66)[39m
[2m   Start at [22m 05:11:32
[2m   Duration [22m 2.49s[2m (transform 469ms, setup 0ms, import 873ms, tests 109ms, environment 1ms)[22m
```
