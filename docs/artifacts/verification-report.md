...
生成时间：2026-08-16T05:16:06.172Z（由 `pnpm verify` 自动生成，勿手改）

| 门禁步骤 | 命令 | 结果 | 耗时 |
|---|---|---|---|
| typecheck（tsc --noEmit 双 tsconfig） | `corepack pnpm typecheck` | ✅ PASS | 22.8s |
...
[2m   Start at [22m 05:16:03
[2m   Duration [22m 2.41s[2m (transform 423ms, setup 0ms, import 835ms, tests 118ms, environment 1ms)[22m
```
