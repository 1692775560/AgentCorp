; AgentCorp Custom NSIS Installer/Uninstaller Script
;
...
!macro customCheckAppRunning
  ...
  ; dialog during upgrades.  The built-in NSIS uninstaller deletes AgentCorp.exe
